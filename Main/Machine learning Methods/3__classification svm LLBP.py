...
train_data = pd.read_csv('data/train_test/LLBP/train_LLBP.csv')
test_data = pd.read_csv('data/train_test/LLBP/test_LLBP.csv')
...
# Save the model
# joblib.dump(svm, 'svm_model_LLBP_me.pkl')
