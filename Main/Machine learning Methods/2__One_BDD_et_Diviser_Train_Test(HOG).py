...
for folder_name in folder_names:
    ...
    csv_files = glob.glob(os.path.join(folder_path, "HOG", "*.csv"))
...
# output_csv_path = "data/combined_data_HOG.csv"  # Output CSV path
...
# Load the entire CSV
# csv_path = "data\combined_data_HOG.csv" 
...
final_train_df.to_csv("data/train_test/HOG/train_HOG.csv", index=False) 
final_test_df.to_csv("data/train_test/HOG/test_HOG.csv", index=False)   
