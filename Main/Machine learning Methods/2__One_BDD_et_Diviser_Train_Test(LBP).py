...
for folder_name in folder_names:
    ...
    csv_files = glob.glob(os.path.join(folder_path, "LBP", "*.csv"))
...
# output_csv_path = "data/combined_data_LBP.csv"  # Output CSV path
...
# Load the entire CSV
# csv_path = "data\combined_data_LBP.csv" 
...
final_train_df.to_csv("data/train_test/LBP/train_LBP.csv", index=False) 
final_test_df.to_csv("data/train_test/LBP/test_LBP.csv", index=False)   
